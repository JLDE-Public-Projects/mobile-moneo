 ...
 * global de Zustand.
 */
export function useLoginMutation(): UseMutationResult<AuthSession, Error, LoginPayload> {
...
export function useRegisterMutation(): UseMutationResult<AuthSession, Error, RegisterPayload> {
   const setSession = useAuthStore((state) => state.setSession);
   return useMutation({
 ...
 */
export function useUpdateProfile(): UseMutationResult<AuthUser, Error, UpdateProfileInput> {
